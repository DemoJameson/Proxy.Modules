...
| -------------------------- | ------------------------------------------------- | -------------------------- | ------------------------------ | ---------------------------- |
| Trakt Simplified Chinese   | 优先补全和显示 Trakt 的简体中文标题、简介等内容，并在影片详情页添加 Forward、Infuse、Rex 跳转按钮 | [`.plugin`][trakt-plugin] | [`.sgmodule`][trakt-sgmodule] | [`.snippet`][trakt-snippet] |
